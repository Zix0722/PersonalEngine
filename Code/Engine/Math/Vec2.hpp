...
public:
	...
	Vec2 const	GetReflected(Vec2 const& vectorNormal) const;
	...
	void		Normalize();
	void		Reflect(Vec2 const& vectorNormal);
...
private:
	Vec2 transformCartesianToPolar_Radians();
	Vec2 transformCartesianToPolar_Degrees();
};
